...
#define INPUT_FILE "C:\\Users\\PC\\Documents\\projeto2\\projeto2\\data\\teste1_ganho.wav"
#define OUTPUT_FILE "C:\\Users\\PC\\Documents\\projeto2\\projeto2\\data\\teste1_ganho00.wav"
...
int main ()
{
    ...
    mudaGanho (dados_l, n_amostras/8, 1.0);
    mudaGanho (dados_r, n_amostras/8, 1.0);
    mudaGanho (dados_l + n_amostras/8, n_amostras/8, 2.0);
    mudaGanho (dados_r + n_amostras/8, n_amostras/8, 2.0);
